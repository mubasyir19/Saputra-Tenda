      ...
      <main className='px-5 md:px-16 lg:px-20 xl:px-28'>
        <section className='my-12 grid grid-cols-2 gap-x-12'>
          ...
          <div className='my-auto'>
            <p className='text-[#B8C1B2] text-lg font-semibold'>About Us</p>
            <h2 className='text-5xl font-semibold mt-3 text-[#576250]' style={yesevaOne.style}>
              We Always Make <br /> The Best
            </h2>
            <p className='mt-3 mb-4 text-justify'>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vel justo sed nibh aliquam volutpat. Cras
              ultricies ante ut nulla commodo, vitae commodo ex cursus. Suspendisse potenti. Nam ac justo id sapien
              aliquam gravida. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae;
              Morbi accumsan nibh in ipsum lobortis, sit amet dignissim metus laoreet.{' '}
            </p>
            <div className='mt-5'>
              <Link href='#' className='px-5 py-3 bg-[#576250] text-white rounded-full text-sm'>
                Contact Us
              </Link>
            </div>
          </div>
        </section>
        <section className='grid grid-cols-2 gap-x-12 my-20'>
          <div className=''>
            <h4 className='text-3xl font-semibold text-[#576250]' style={yesevaOne.style}>
              Pelayanan Kami
            </h4>
            <div className='mt-4'>
              <div>
                <p className='text-lg py-2 px-4 bg-[#B8C1B2] text-[#576250] font-medium rounded-lg my-2'>
                  Rumbai Tenda
                </p>
              </div>
              <div>
        ...
        <section className='grid grid-cols-2 gap-x-12'>
          <div className='place-content-center w-3/4 mx-auto'>
            <div className='card-contact mt-4 w-full p-4 bg-[#F0F2EF]'>
        ...
        <section className='my-20'>
          <div className='relative bg-background bg-cover bg-center w-full h-96 rounded-xl'>
            <div className='bg-black bg-opacity-50 w-full h-full rounded-xl flex justify-center items-center text-center'>
              <div className='text-white w-1/2'>
                ...
                <div className='mt-8'>
                  <Link href='#' className='py-3 px-5 text-sm text-black bg-white rounded-full'>
                    Get Started
                  </Link>
                </div>
              </div>
